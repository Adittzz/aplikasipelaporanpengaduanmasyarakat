        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?= base_url('User/ProfileController') ?>" class="nav-link">
                  <p>Profile</p>
                </a>
              </li>
            </ul>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-4 col-6">
            <!-- small box -->
            <div class="small-box" style="border-radius: 8px;">
              <div class="inner text-white" id="accordionSidebar" style="border-radius: 8px;">
                <h3>4</h3>
