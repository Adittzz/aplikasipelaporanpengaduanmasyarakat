...
<div id="wrapper">
  ...
  <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center text-white">
      ...
      <div class="sidebar-brand-text mx-3">Admin Pengaduan Masyarakat</div>
    </a>
    ...
    <a class="nav-link" href="<?= base_url('Admin/DashboardController'); ?>">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?= base_url('Admin/PetugasController'); ?>" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
          <i class="fas fa-user"></i>
          <span>Tambah Petugas</span>
        </a>
      </li>
      <li class="nav-item">
    <a class="nav-link" href="<?= base_url('Admin/TanggapanController'); ?>">
      <i class="fas fa-file-pdf"></i>
      <span>Pengaduan Masuk</span></a>
    </li>
    <li class="nav-item">
    <a class="nav-link" href="<?= base_url('Admin/TanggapanController/tanggapan_proses'); ?>">
      <i class="fas fa-file-pdf"></i>
      <span>Pengaduan Proses</span></a>
    </li>
    <li class="nav-item">
    <a class="nav-link" href="<?= base_url('Admin/TanggapanController/tanggapan_selesai'); ?>">
      <i class="fas fa-file-pdf"></i>
      <span>Pengaduan Selesai</span></a>
    </li>
    <li class="nav-item">
    <a class="nav-link" href="<?= base_url('Admin/TanggapanController/tanggapan_tolak'); ?>">
      <i class="fas fa-file-pdf"></i>
      <span>Pengaduan Ditolak</span></a>
    </li>
    <li class="nav-item">
