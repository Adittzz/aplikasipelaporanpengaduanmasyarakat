...
<div class="container-fluid mb-2">
  ...
  <div class="card no-border mb-3 col-lg-8">
    ...
    <div class="row no-gutters">
      ...
      <div class="col-md-6">
        <div class="card-body">
          <h5 class="card-title" style="color: black;">Tgl Pengaduan : <?= $data_pengaduan['tgl_pengaduan']; ?></h5>
          <p class="card-text" style="color: black;">Status : <?= $data_pengaduan['status'] == 0 ? 'Belum di verifikasi' : ''; ?></p>
          <p class="card-text" style="color: black;"><small class="text-muted">Laporan : <?= $data_pengaduan['isi_laporan'] ?></small></p>
        </div>
      </div>
    </div>
  </div>
